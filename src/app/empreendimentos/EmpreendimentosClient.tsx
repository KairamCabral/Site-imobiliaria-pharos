...
export function EmpreendimentosClient({
  ...
  return (
    <>
      ...
      {/* Hero minimalista - Mobile-First */}
      <section 
        className="relative overflow-hidden bg-gradient-to-b from-[#0b1220] via-[#0f1a30] to-[#0b1220] text-white"
        role="banner"
        aria-label="Empreendimentos Premium"
      >
        <div className="absolute inset-0">
          <Image
            src="/images/banners/balneario-camboriu.webp"
            alt="Empreendimentos Premium em Balneário Camboriú"
            fill
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-12 md:py-14 lg:py-16 xl:py-20">
          <motion.div
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:py-1 rounded-full bg-white/12 border border-white/15">
              <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-emerald-400 animate-pulse" aria-hidden="true" />
              <span className="text-xs sm:text-sm font-semibold tracking-wide">Curadoria premium Pharos</span>
            </div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight drop-shadow-md text-white">
              Empreendimentos em Balneário Camboriú, Itajaí e Camboriú
            </h1>
            <p className="text-sm sm:text-base md:text-lg text-white/85 max-w-3xl leading-relaxed">
      ...
      {/* Listagem de Empreendimentos - Mobile-First */}
      <section className="py-6 sm:py-8 md:py-12 lg:py-16 bg-pharos-offwhite">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6">
          {isLoading ? (
            // Loading Skeletons - Mobile-First
            <div className={viewMode === 'grid'
              ? 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 lg:gap-8'
            ...
            <>
              ...
              <motion.div
                ...
                className="text-center mt-8 sm:mt-10 md:mt-12 text-pharos-slate-700"
              >
