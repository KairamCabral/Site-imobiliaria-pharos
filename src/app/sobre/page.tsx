  ...
  return (
    <>
      ...
      >
        ...
        {/* Scroll indicator minimalista - Oculto em mobile */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      {/* Seções com lazy loading - Mobile Optimizado */}
      <LazySection 
        rootMargin="320px 0px" 
        fallback={<div className="min-h-[140px] sm:min-h-[160px] w-full bg-transparent" />}
        className="w-full"
      >
        <AnimatedStats />
      </LazySection>
      ...
      <LazySection 
        ...
        fallback={<div className="min-h-[180px] sm:min-h-[200px] bg-transparent" />}
        className="w-full"
      >
        <HistorySection />
      </LazySection>
