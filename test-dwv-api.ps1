# Script para testar DWV API e salvar resposta
# Execução: .\test-dwv-api.ps1

$token = "4b3e322a7773c8b3498606ed5d086a613171c65d542acbacd41b41af51d1d59a"
$url = "https://apisandbox.dwvapp.com.br/integration/properties?limit=5"

Write-Host "=== Testando DWV API ===" -ForegroundColor Cyan
...
try {
    ...
    $response | ConvertTo-Json -Depth 10 | Out-File -FilePath "dwv-response.json" -Encoding UTF8
    
    Write-Host "✓ Resposta salva em: dwv-response.json" -ForegroundColor Green
    Write-Host ""
